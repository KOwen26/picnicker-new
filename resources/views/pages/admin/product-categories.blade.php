    ...
    <div>
        <div class="p-4 mb-6 bg-white rounded-lg shadow-md">
            <div class="flex flex-row content-center justify-between px-3 mt-3 mb-8 ">
                <h4 class="text-xl font-medium ">Products Categories Data</h4>
                <button
                    ...
                    type="button" onclick="Livewire.emit('openModal', 'products.product-categories-details')">
                    <i class="mr-2 fas fa-plus"></i>
                    Tambah Kategori Produk (Tiket) Merchant
                </button>
            </div>
            <div class="container p-3 mx-auto">
                <livewire:products.product-categories-table />
            </div>
        </div>
    </div>
@endsection
