        ...
        <div class="flex justify-between flex-1 sm:hidden">
            ...
            @else
                <a href="{{ $paginator->previousPageUrl() }}"
                    class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:bg-secondary-700/80 focus:outline-none focus:ring-blue focus:border-blue-300 active:bg-secondary-700 hover:text-white active:text-white">
                    {!! __('pagination.previous') !!}
                </a>
            @endif
                ...
                <span class="relative z-0 inline-flex shadow-sm">
                    ...
                    @else
                        <a href="{{ $paginator->previousPageUrl() }}" rel="prev"
                            class="relative inline-flex items-center px-2 py-2 text-sm font-medium leading-5 text-gray-500 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-l-md hover:bg-secondary-700/80 focus:z-10 focus:outline-none focus:border-blue-300 focus:ring-blue active:bg-secondary-700 hover:text-white active:text-white"
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @else
                                    <a href="{{ $url }}"
                                        class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 hover:bg-secondary-700/80 focus:z-10 focus:outline-none focus:border-blue-300 focus:ring-blue active:bg-secondary-700 hover:text-white active:text-white"
                    ...
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next"
                            class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium leading-5 text-gray-500 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-r-md hover:bg-secondary-700/80 focus:z-10 focus:outline-none focus:border-blue-300 focus:ring-blue active:bg-secondary-700 hover:text-white active:text-white"
